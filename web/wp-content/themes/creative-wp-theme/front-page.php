...
while ( have_posts() ) {
    ...
    <img class="w-full max-h-25 object-cover object-top min-h-16" src="<?php echo get_theme_mod( 'creative_hero_image' ); ?>" alt="">

    <main role="main" id="main" class="contained">
	    <section class="mb-16 mt-10 text-center">
		    <h1 class="md:text-4xl uppercase leading-none text-michigan-blue mb-12">
