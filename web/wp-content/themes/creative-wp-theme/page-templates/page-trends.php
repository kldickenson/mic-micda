<?php
/* Template Name: TRENDS People Page
*/
?>
<?php get_header(); ?>
        ...
        <article>
            ...
            <div class="w-screen affiliates pb-4">
                <section id="affiliates" class="container mx-auto pt-16 pb-0 max-w-5xl px-4">
                    <h3 class="text-xl font-bold mb-4 md:mb-12 inline-block w-1/4"><?php echo __( 'Network Affiliates', 'creative-wp-theme' ); ?></h3>
                    ...
                    <ul>
						...
						?>
						<?php
						set_query_var( 'args', $trends_affiliates );
						get_template_part( 'template-parts/content', 'persons' );
						?>
                    </ul>
                </section>
